...
const documents: Documents = {
    ...
    "mutation InviteByEmail($boardId: ID!, $email: String!, $role: BoardRole!) {\n  inviteByEmail(boardId: $boardId, email: $email, role: $role) {\n    id\n    email\n    role\n    status\n  }\n}": types.InviteByEmailDocument,
    "mutation Login($email: String!, $password: String!) {\n  login(email: $email, password: $password) {\n    token\n    user {\n      id\n      email\n      name\n    }\n  }\n}": types.LoginDocument,
    "mutation MoveTask($id: ID!, $columnId: ID!, $position: Int) {\n  moveTask(id: $id, columnId: $columnId, position: $position) {\n    id\n    columnId\n    position\n    statusId\n    updatedAt\n  }\n}": types.MoveTaskDocument,
    "mutation Register($email: String!, $password: String!, $name: String) {\n  register(email: $email, password: $password, name: $name) {\n    token\n    user {\n      id\n      email\n      name\n      createdAt\n    }\n  }\n}": types.RegisterDocument,
    "mutation UpdateBoard($id: ID!, $title: String, $description: String, $visibility: BoardVisibility) {\n  updateBoard(\n    id: $id\n    title: $title\n    description: $description\n    visibility: $visibility\n  ) {\n    id\n    title\n    description\n    visibility\n    createdAt\n    updatedAt\n  }\n}": types.UpdateBoardDocument,
    "mutation UpdateBoardMemberRole($boardId: ID!, $userId: ID!, $role: BoardRole!) {\n  updateBoardMemberRole(boardId: $boardId, userId: $userId, role: $role) {\n    userId\n    role\n    user {\n      id\n      email\n      name\n    }\n  }\n}": types.UpdateBoardMemberRoleDocument,
    ...
    "query BoardMembers($boardId: ID!) {\n  boardMembers(boardId: $boardId) {\n    role\n    user {\n      id\n      name\n      email\n    }\n  }\n}": types.BoardMembersDocument,
    "query Boards($first: Int, $after: String, $last: Int, $before: String, $visibility: BoardVisibility, $sortBy: BoardSortBy, $sortOrder: SortOrder) {\n  boards(\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n    visibility: $visibility\n    sortBy: $sortBy\n    sortOrder: $sortOrder\n  ) {\n    edges {\n      cursor\n      node {\n        id\n        title\n        description\n        permissions {\n          createTask\n          updateTask\n          deleteTask\n          moveCard\n          moveColumn\n          createColumn\n          manageLabels\n          inviteMember\n          manageBoardMembers\n        }\n        visibility\n        createdAt\n        updatedAt\n      }\n    }\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n  }\n}": types.BoardsDocument,
    "query Columns($boardId: ID!) {\n  columns(boardId: $boardId) {\n    id\n    boardId\n    title\n    position\n    statusId\n    createdAt\n    updatedAt\n  }\n}": types.ColumnsDocument,
    "query Me {\n  me {\n    id\n    email\n    name\n    createdAt\n  }\n}": types.MeDocument,
    "query PendingInvites($boardId: ID!) {\n  pendingInvites(boardId: $boardId) {\n    id\n    email\n    role\n    status\n  }\n}": types.PendingInvitesDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation InviteByEmail($boardId: ID!, $email: String!, $role: BoardRole!) {\n  inviteByEmail(boardId: $boardId, email: $email, role: $role) {\n    id\n    email\n    role\n    status\n  }\n}"): (typeof documents)["mutation InviteByEmail($boardId: ID!, $email: String!, $role: BoardRole!) {\n  inviteByEmail(boardId: $boardId, email: $email, role: $role) {\n    id\n    email\n    role\n    status\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation UpdateBoardMemberRole($boardId: ID!, $userId: ID!, $role: BoardRole!) {\n  updateBoardMemberRole(boardId: $boardId, userId: $userId, role: $role) {\n    userId\n    role\n    user {\n      id\n      email\n      name\n    }\n  }\n}"): (typeof documents)["mutation UpdateBoardMemberRole($boardId: ID!, $userId: ID!, $role: BoardRole!) {\n  updateBoardMemberRole(boardId: $boardId, userId: $userId, role: $role) {\n    userId\n    role\n    user {\n      id\n      email\n      name\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query BoardMembers($boardId: ID!) {\n  boardMembers(boardId: $boardId) {\n    role\n    user {\n      id\n      name\n      email\n    }\n  }\n}"): (typeof documents)["query BoardMembers($boardId: ID!) {\n  boardMembers(boardId: $boardId) {\n    role\n    user {\n      id\n      name\n      email\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query PendingInvites($boardId: ID!) {\n  pendingInvites(boardId: $boardId) {\n    id\n    email\n    role\n    status\n  }\n}"): (typeof documents)["query PendingInvites($boardId: ID!) {\n  pendingInvites(boardId: $boardId) {\n    id\n    email\n    role\n    status\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "subscription TaskCreated($boardId: ID!) {\n  taskCreated(boardId: $boardId) {\n    id\n    columnId\n    title\n    description\n    priority\n    statusId\n    labelIds\n    dueDate\n    assigneeId\n    position\n    createdAt\n    updatedAt\n  }\n}"): (typeof documents)["subscription TaskCreated($boardId: ID!) {\n  taskCreated(boardId: $boardId) {\n    id\n    columnId\n    title\n    description\n    priority\n    statusId\n    labelIds\n    dueDate\n    assigneeId\n    position\n    createdAt\n    updatedAt\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "subscription TaskDeleted($boardId: ID!) {\n  taskDeleted(boardId: $boardId) {\n    id\n  }\n}"): (typeof documents)["subscription TaskDeleted($boardId: ID!) {\n  taskDeleted(boardId: $boardId) {\n    id\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "subscription TaskUpdated($boardId: ID!) {\n  taskUpdated(boardId: $boardId) {\n    id\n    columnId\n    title\n    description\n    priority\n    statusId\n    labelIds\n    dueDate\n    assigneeId\n    position\n    createdAt\n    updatedAt\n  }\n}"): (typeof documents)["subscription TaskUpdated($boardId: ID!) {\n  taskUpdated(boardId: $boardId) {\n    id\n    columnId\n    title\n    description\n    priority\n    statusId\n    labelIds\n    dueDate\n    assigneeId\n    position\n    createdAt\n    updatedAt\n  }\n}"];
